...
def page1(c,D):
    ...
    checkbox(c,M,y-0.5,checked=False); mtext(c,['2.1. Сопровождаемый','багаж, включая','ручную кладь'],M+4.5,y,7)
    ...
    checkbox(c,M,y,checked=False);t(c,'Ввоз (свободное',M+4.5,y,7);t(c,'обращение)',M+4.5,y-3.8,7)
    checkbox(c,M+45,y,checked=False);t(c,'Вывоз',M+49.5,y,7)
